...
<div class="page">
   <div class="page-header">
      <h1 class="page-title">Missiyamız</h1>
   </div>
               ...
               <div class="col-md-12 col-lg-12">
                  ...
                  <form method="POST" action="{{route('admin.setting.update')}}" enctype="multipart/form-data">
                     ...
                     <div class="example-wrap">
                        ...
                        <input type="text" class="form-control round" name="about_title1" value="{{$setting->about_title1}}">
                     </div>
                     <div class="example-wrap">
                         <h4 class="example-title">Məzmun</h4>
                         <textarea class="form-control" name="about_description1" rows="15">{{$setting->about_description1}}</textarea>
                     </div>
                     <div class="example-wrap">
                        <h4 class="example-title">Şəkil Logo</h4>
                        <img width="150" src="{{asset($setting->about_img1)}}" />         
                     </div>
                     <div class="example-wrap">
                        <h4 class="example-title">Şəkil</h4>
                        <input type="file" class="filestyle" name="about_img1"  data-buttonname="btn-secondary" > 
                    </div>
