...
<div class="page">
   <div class="page-header">
      <h1 class="page-title">Əsas Səhifə - SEO</h1>
   </div>
               ...
               <div class="col-md-12 col-lg-12">
                  ...
                  <form method="POST" action="{{route('admin.setting.update')}}" enctype="multipart/form-data">
                     ...
                     <div class="example-wrap">
                        ...
                        <input type="text" class="form-control round" id="title" name="title" value="{{$setting->title}}">
                     </div>
                     <div class="example-wrap">
                        <h4 class="example-title">Description</h4>
                        <input type="text" class="form-control round" id="description" name="description" value="{{$setting->description}}">
                     </div>
